%sense_setup - Template for calling parametric_senseplot_vH3.
%
% Inputs:
%    none
%
...
tdelay_min= 200e-12; % warning: the smaller this is, the longer the
                    % computation time of the thermal model.
tdelay_max= 200e-12; % approx. max extent of our delay stage.
...
thickness = [1 80 1 1e9]; % thickness in nm of each model layer
