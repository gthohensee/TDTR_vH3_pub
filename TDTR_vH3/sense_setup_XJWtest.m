...
objective = 5; % strength of objective lens
...
tdelay_min= 4000e-12; % warning: the smaller this is, the longer the
                    % computation time of the thermal model.
tdelay_max= 4000e-12; % approx. max extent of our delay stage.
...
thickness = [1 87 1 60 1e9]; % thickness in nm of each model layer
...
%% Tweak LCTE
LCTE(1,3) = 0.1; % should be irrelevant
LCTE(1,4) = 0.05; % PCBNB?
LCTE(2,4) = 1.3e6; % PCBNB?
matparams{1} = LCTE;
